...
export default class AddTask extends React.Component {
  ...
  handleAddTask = (e) => {
    ...
    const goal = e.target.elements.goals ? e.target.elements.goals.value : this.props.goalIndex;
    console.log("goalindex", goal);
  ...
  render(){
    ...
    return (
      ...
      <form onSubmit={this.handleAddTask}>
        ...
        {this.props.display === "today"  && displayCategoriesList()}
        {this.props.display === "today"  && displayGoalsList()}
